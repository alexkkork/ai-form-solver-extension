  ...
  async function fillGoogleFormField(field, value) {
    ...
    switch (field.type) {
      ...
      case 'email':
        ...
        // Method 1: Focus and prepare the field
        input.focus();
        input.click();
        ...
        // Method 2: Use different approach based on text length
        if (valueStr.length > 10) {
          console.log('🔄 Using enhanced approach for longer text...');
          
          // For longer text, build it character by character with events
          for (let i = 0; i < valueStr.length; i++) {
            ...
            // Small delay every 20 characters for Google Forms to process
            if (i % 20 === 0 && i > 0) {
              await new Promise(resolve => setTimeout(resolve, 10));
            }
          }
          
          // Final events after all text is set
          ...
          // Fire events for shorter text too
