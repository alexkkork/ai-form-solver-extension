  ...
  async function fillGoogleFormField(field, value) {
    ...
    switch (field.type) {
      ...
      case 'email':
        ...
        // Simulate typing for Google Forms validation
        input.dispatchEvent(new Event('focus', { bubbles: true }));
        input.dispatchEvent(new Event('input', { bubbles: true }));
        input.dispatchEvent(new Event('change', { bubbles: true }));
        
        // For Google Forms, we need to trigger multiple events in sequence
        await new Promise(resolve => setTimeout(resolve, 100));
        
        // Trigger keyup events to simulate real typing
        ...
        // Wait longer to ensure Google Forms processes the change
